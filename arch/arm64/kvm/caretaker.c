				 ...
				 struct kvm_vcpu_luo_ser *ser)
{
	...
	{
		struct caretaker_arm64_vm *vm = vcpu->kvm->arch.caretaker_vm;
	...
	vcpu->caretaker.cb.runtime_pa = cap->cb.runtime_pa;
	vcpu->caretaker.cb.runtime_size = cap->cb.runtime_size;
