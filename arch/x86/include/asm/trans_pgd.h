...
/*
 * Transitional page tables for x86.
 *
 * Copyright (c) 2026, Pasha Tatashin <pasha.tatashin@soleen.com>
 */
#ifndef _ASM_X86_TRANS_PGD_H
#define _ASM_X86_TRANS_PGD_H
 ...
 *	  allocator fails, trans_pgd functions return -ENOMEM error.
 *
 * trans_alloc_arg
 ...
 *
 * 1. Preserved Executable Text & Rodata (PAGE_KERNEL_ROX):
 ...
 *
 * 4. Workload Attachment & Context Pages (PAGE_KERNEL, NX):
 *    KHO-preserved workload architectural state pages
 *    holding guest/host registers, VMCS/VMCB pointers, and control areas.
 *
 * 5. Hardware Control:
 *    Local APIC is accessed exclusively via x2APIC MSRs; no MMIO or fixmap
 *    mappings are created in transition page tables.
 *
 ...
 * - Guest physical memory (translated directly via EPT/NPT second-level paging).
 */
