 ...
 * @cpu:           Logical CPU identifier.
 * @client_ser_pa: Physical address of the registered workload client's own
 *                 serialized state, or 0.  Opaque to CPU preservation, which
 *                 only stores this value and hands it back to the client on
 *                 the other side of the kexec; its layout is defined by
 *                 whichever client is registered.
