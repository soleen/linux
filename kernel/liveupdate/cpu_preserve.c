...
bool __cpu_preserved_text cpu_is_preserved(int cpu)
{
	...
	arch_cpu_preserved_dcache_inval((unsigned long)&cpu_preserved_mask,
					(unsigned long)&cpu_preserved_mask +
					sizeof(cpu_preserved_mask));
...
EXPORT_SYMBOL_GPL(cpu_preserved_get_stack_info);
...
EXPORT_SYMBOL_GPL(cpu_preserved_get_pcpus_info);
...
DEFINE_SHOW_ATTRIBUTE(cpu_preserve_status);
...
DEFINE_SHOW_ATTRIBUTE(cpu_preserve_cpu_status);
...
DEFINE_SHOW_ATTRIBUTE(cpu_preserve_workload);
...
DEFINE_SHOW_ATTRIBUTE(cpu_preserve_origin);
...
DEFINE_SHOW_ATTRIBUTE(cpu_preserve_session);
